...
const dataLocation = path.join(`${__dirname}/../docs/data/`);
const uploads = path.join(`${__dirname}/../docs/upload/`);


app.use(bodyParser.urlencoded({ extended: false }))
app.use(bodyParser.json())
app.use("/upload", express.static(`${__dirname}/../docs/upload`));
app.use(fileUpload());
//app.use(express.json())
app.use("/data", express.static(`${__dirname}/../docs/data`))
...
app.use("/public", express.static(`${__dirname}/../docs/public`))
